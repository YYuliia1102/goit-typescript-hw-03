...
class Manager extends Employee {
  constructor(name: string, department: string, salary: number) {
    super(name, department, salary + 10000); // Виклик конструктора батьківського класу та збільшення зарплати на 10000
  }
}

// Приклад використання класу Manager
const manager = new Manager('John Doe', 'Management', 50000);
console.log(manager.getEmployeeDetails()); // Поверне Name: John Doe, Department: Management, Salary: 60000
